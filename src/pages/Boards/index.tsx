...
import { FiChevronDown, FiClock, FiHome, FiPlus, FiSettings, FiStar, FiTrello, FiUser } from 'react-icons/fi';
            ...
            <div className="layout-boards">
                ...
                <div className="content-home">
                    ...
                    <div className="destaque-name">
                        ...
                        <Button text='Tabela da Área de trabalho'>
                            <CgViewList/>
                        </Button>
                        <Button text='Membros (210)'>
                            <FiUser/>
                        </Button>
                        <Button text='Configurações'>
                            <FiSettings/>
                        </Button>
                        <Button text='Atualizar' brief>
                            <FiSettings/>
                        </Button>
                    </div>
                    <div className="row-cards">
                    ...
                    <div className="destaque-name">
                        <Button text='Ver todos os quadros fechados'/>
                    </div>
                </div>
            </div>
        </div>
